...
/**
 * CopperTier CLASS IS CORE PART OF [MBB] AUSTENIUM CopperTier.java.
 *
 * com.mbb.austenium.content.item.CopperTier:
 *     Tool material of the copper tier: mining level, durability, speed and attack values.
 */

...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>> COPPER_FURNACE
        = BLOCK_ENTITIES.register("copper_furnace",
            () -> BlockEntityType.Builder.of(CopperFurnaceBlockEntity::new,
                ModBlocks.COPPER_FURNACE.get()).build(null));

    public static final RegistryObject<BlockEntityType<?>> COPPER_BLAST_FURNACE
        = BLOCK_ENTITIES.register("copper_blast_furnace",
            () -> BlockEntityType.Builder.of(CopperBlastFurnaceBlockEntity::new,
                ModBlocks.COPPER_BLAST_FURNACE.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> IRON_BLAST_FURNACE
        = BLOCK_ENTITIES.register("iron_blast_furnace",
            () -> BlockEntityType.Builder.of(IronBlastFurnaceBlockEntity::new,
                ModBlocks.IRON_BLAST_FURNACE.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> SILVER_FURNACE
        = BLOCK_ENTITIES.register("silver_furnace",
            () -> BlockEntityType.Builder.of(SilverFurnaceBlockEntity::new,
                ModBlocks.SILVER_FURNACE.get()).build(null));

    public static final RegistryObject<BlockEntityType<?>> SILVER_BLAST_FURNACE
        = BLOCK_ENTITIES.register("silver_blast_furnace",
            () -> BlockEntityType.Builder.of(SilverBlastFurnaceBlockEntity::new,
                ModBlocks.SILVER_BLAST_FURNACE.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> GOLD_BLAST_FURNACE
        = BLOCK_ENTITIES.register("gold_blast_furnace",
            () -> BlockEntityType.Builder.of(GoldBlastFurnaceBlockEntity::new,
                ModBlocks.GOLD_BLAST_FURNACE.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> DIAMOND_BLAST_FURNACE
        = BLOCK_ENTITIES.register("diamond_blast_furnace",
            () -> BlockEntityType.Builder.of(DiamondBlastFurnaceBlockEntity::new,
                ModBlocks.DIAMOND_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> DIAMOND_SMOKER
        = BLOCK_ENTITIES.register("diamond_smoker",
            () -> BlockEntityType.Builder.of(DiamondSmokerBlockEntity::new,
                ModBlocks.DIAMOND_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> DIAMOND_BARREL
        = BLOCK_ENTITIES.register("diamond_barrel",
            () -> BlockEntityType.Builder.of(DiamondBarrelBlockEntity::new,
                ModBlocks.DIAMOND_BARREL.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> EMERALD_BLAST_FURNACE
        = BLOCK_ENTITIES.register("emerald_blast_furnace",
            () -> BlockEntityType.Builder.of(EmeraldBlastFurnaceBlockEntity::new,
                ModBlocks.EMERALD_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> EMERALD_SMOKER
        = BLOCK_ENTITIES.register("emerald_smoker",
            () -> BlockEntityType.Builder.of(EmeraldSmokerBlockEntity::new,
                ModBlocks.EMERALD_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> EMERALD_BARREL
        = BLOCK_ENTITIES.register("emerald_barrel",
            () -> BlockEntityType.Builder.of(EmeraldBarrelBlockEntity::new,
                ModBlocks.EMERALD_BARREL.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> ORICHALCUM_FURNACE
        = BLOCK_ENTITIES.register("orichalcum_furnace",
            () -> BlockEntityType.Builder.of(OrichalcumFurnaceBlockEntity::new,
                ModBlocks.ORICHALCUM_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ORICHALCUM_BLAST_FURNACE
        = BLOCK_ENTITIES.register("orichalcum_blast_furnace",
            () -> BlockEntityType.Builder.of(OrichalcumBlastFurnaceBlockEntity::new,
                ModBlocks.ORICHALCUM_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ORICHALCUM_SMOKER
        = BLOCK_ENTITIES.register("orichalcum_smoker",
            () -> BlockEntityType.Builder.of(OrichalcumSmokerBlockEntity::new,
                ModBlocks.ORICHALCUM_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ORICHALCUM_BARREL
        = BLOCK_ENTITIES.register("orichalcum_barrel",
            () -> BlockEntityType.Builder.of(OrichalcumBarrelBlockEntity::new,
                ModBlocks.ORICHALCUM_BARREL.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ORICHALCUM_CHEST
        = BLOCK_ENTITIES.register("orichalcum_chest",
            () -> BlockEntityType.Builder.of(OrichalcumChestBlockEntity::new,
                ModBlocks.ORICHALCUM_CHEST.get()).build(null));

    public static final RegistryObject<BlockEntityType<?>> MYTHRIL_FURNACE
        = BLOCK_ENTITIES.register("mythril_furnace",
            () -> BlockEntityType.Builder.of(MythrilFurnaceBlockEntity::new,
                ModBlocks.MYTHRIL_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> MYTHRIL_BLAST_FURNACE
        = BLOCK_ENTITIES.register("mythril_blast_furnace",
            () -> BlockEntityType.Builder.of(MythrilBlastFurnaceBlockEntity::new,
                ModBlocks.MYTHRIL_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> MYTHRIL_SMOKER
        = BLOCK_ENTITIES.register("mythril_smoker",
            () -> BlockEntityType.Builder.of(MythrilSmokerBlockEntity::new,
                ModBlocks.MYTHRIL_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> MYTHRIL_BARREL
        = BLOCK_ENTITIES.register("mythril_barrel",
            () -> BlockEntityType.Builder.of(MythrilBarrelBlockEntity::new,
                ModBlocks.MYTHRIL_BARREL.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> ADAMANTITE_FURNACE
        = BLOCK_ENTITIES.register("adamantite_furnace",
            () -> BlockEntityType.Builder.of(AdamantiteFurnaceBlockEntity::new,
                ModBlocks.ADAMANTITE_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ADAMANTITE_BLAST_FURNACE
        = BLOCK_ENTITIES.register("adamantite_blast_furnace",
            () -> BlockEntityType.Builder.of(AdamantiteBlastFurnaceBlockEntity::new,
                ModBlocks.ADAMANTITE_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ADAMANTITE_SMOKER
        = BLOCK_ENTITIES.register("adamantite_smoker",
            () -> BlockEntityType.Builder.of(AdamantiteSmokerBlockEntity::new,
                ModBlocks.ADAMANTITE_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ADAMANTITE_BARREL
        = BLOCK_ENTITIES.register("adamantite_barrel",
            () -> BlockEntityType.Builder.of(AdamantiteBarrelBlockEntity::new,
                ModBlocks.ADAMANTITE_BARREL.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> ADAMANTITE_CHEST
        = BLOCK_ENTITIES.register("adamantite_chest",
            () -> BlockEntityType.Builder.of(AdamantiteChestBlockEntity::new,
                ModBlocks.ADAMANTITE_CHEST.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> NETHERITE_BLAST_FURNACE
        = BLOCK_ENTITIES.register("netherite_blast_furnace",
            () -> BlockEntityType.Builder.of(NetheriteBlastFurnaceBlockEntity::new,
                ModBlocks.NETHERITE_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> NETHERITE_SMOKER
        = BLOCK_ENTITIES.register("netherite_smoker",
            () -> BlockEntityType.Builder.of(NetheriteSmokerBlockEntity::new,
                ModBlocks.NETHERITE_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> NETHERITE_BARREL
        = BLOCK_ENTITIES.register("netherite_barrel",
            () -> BlockEntityType.Builder.of(NetheriteBarrelBlockEntity::new,
                ModBlocks.NETHERITE_BARREL.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> NETHERITE_CHEST
        = BLOCK_ENTITIES.register("netherite_chest",
            () -> BlockEntityType.Builder.of(NetheriteChestBlockEntity::new,
                ModBlocks.NETHERITE_CHEST.get()).build(null));

    public static final RegistryObject<BlockEntityType<?>> RADIANT_FURNACE
        = BLOCK_ENTITIES.register("radiant_furnace",
            () -> BlockEntityType.Builder.of(RadiantFurnaceBlockEntity::new,
                ModBlocks.RADIANT_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> RADIANT_BLAST_FURNACE
        = BLOCK_ENTITIES.register("radiant_blast_furnace",
            () -> BlockEntityType.Builder.of(RadiantBlastFurnaceBlockEntity::new,
                ModBlocks.RADIANT_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> RADIANT_SMOKER
        = BLOCK_ENTITIES.register("radiant_smoker",
            () -> BlockEntityType.Builder.of(RadiantSmokerBlockEntity::new,
                ModBlocks.RADIANT_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> RADIANT_BARREL
        = BLOCK_ENTITIES.register("radiant_barrel",
            () -> BlockEntityType.Builder.of(RadiantBarrelBlockEntity::new,
                ModBlocks.RADIANT_BARREL.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> AURELIANIUM_FURNACE
        = BLOCK_ENTITIES.register("aurelianium_furnace",
            () -> BlockEntityType.Builder.of(AurelianiumFurnaceBlockEntity::new,
                ModBlocks.AURELIANIUM_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> AURELIANIUM_BLAST_FURNACE
        = BLOCK_ENTITIES.register("aurelianium_blast_furnace",
            () -> BlockEntityType.Builder.of(AurelianiumBlastFurnaceBlockEntity::new,
                ModBlocks.AURELIANIUM_BLAST_FURNACE.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> AURELIANIUM_SMOKER
        = BLOCK_ENTITIES.register("aurelianium_smoker",
            () -> BlockEntityType.Builder.of(AurelianiumSmokerBlockEntity::new,
                ModBlocks.AURELIANIUM_SMOKER.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> AURELIANIUM_BARREL
        = BLOCK_ENTITIES.register("aurelianium_barrel",
            () -> BlockEntityType.Builder.of(AurelianiumBarrelBlockEntity::new,
                ModBlocks.AURELIANIUM_BARREL.get()).build(null));
    public static final RegistryObject<BlockEntityType<?>> AURELIANIUM_CHEST
        = BLOCK_ENTITIES.register("aurelianium_chest",
            () -> BlockEntityType.Builder.of(AurelianiumChestBlockEntity::new,
                ModBlocks.AURELIANIUM_CHEST.get()).build(null));

    public static final RegistryObject<BlockEntityType<?>> TIER_HOPPER
        = BLOCK_ENTITIES.register("tier_hopper",
            () -> BlockEntityType.Builder.of(TierHopperBlockEntity::new,
                ModBlocks.COPPER_HOPPER.get(),
                ModBlocks.IRON_HOPPER.get(),
                ModBlocks.SILVER_HOPPER.get(),
                ModBlocks.GOLD_HOPPER.get(),
                ModBlocks.DIAMOND_HOPPER.get(),
                ModBlocks.EMERALD_HOPPER.get(),
                ModBlocks.ORICHALCUM_HOPPER.get(),
                ModBlocks.MYTHRIL_HOPPER.get(),
                ModBlocks.ADAMANTITE_HOPPER.get(),

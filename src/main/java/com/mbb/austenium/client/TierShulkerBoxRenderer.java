...
public class TierShulkerBoxRenderer implements BlockEntityRenderer<TierShulkerBoxBlockEntity> {
    ...
    @Override
    public void render(TierShulkerBoxBlockEntity blockEntity, float partialTick, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
        ...
        Material material = new Material(InventoryMenu.BLOCK_ATLAS,
            new ResourceLocation(MbbAustenium.MOD_ID, "block/" + tierId + "_shulker_box"));
        ...
        VertexConsumer consumer = material.buffer(buffers, RenderType::entityCutoutNoCull);
